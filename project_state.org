...
** Fine-tune ROBERTA with hyperparameters(Sudarshan)

* Action #4 Retrieval Strategy                                           :#4:
** IN PROGRESS Don’s stop pretraining (Focus on last few chapters)
...
** IN PROGRESS VAMPIRE(https://github.com/allenai/vampire)
   - This is the augmentation method for the previous paper "don't stop pretraining"
   - Got it working without any issue.

** IN PROGRESS Unsupervised Clustering https://arxiv.org/pdf/2004.02105.pdf

** TODO Better Retrieval Strategy
...
* Action #5 Acquire Previous Work from Oracle                            :#5:
** WAITING Waiting for response

* Action #6 Collect Relevant Papers                                      :#6:
