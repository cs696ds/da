...
\label{sec:org694a868}

\subsection{Augmentation by Distance}
\label{sec:orgef21dcf}
\subsubsection{Size Table}
\label{sec:org043fc07}
\begin{center}
...
\label{sec:org37867b8}
\subsubsection{F1 Table}
\label{sec:orgb185765}
\begin{center}
\begin{tabular}{|c|c|c|c|c|}
\hline
Dataset \# & ACL & Hyper & RCT\(_{\emph{sample}}\) & Interval\\
\hline
Baseline & 62.70 & 90.24 & \textbf{73.60} & -\\
\hline
