...
* TODO Action #01 Review Papers [0%]
  - [ ] Discuss [[./papers/2004.10964.pdf][Don’t stop pretraining:Adapt language models to domains and tasks.(2020)]]
  ...
  - [ ] Discuss [[./papers/2004.02105.pdf][Unsupervised domain clusters in pretrained language models.(2020)]] 
  - [ ] Discuss [[./papers/2004.04906.pdf][Dense Passage Retrieval for Open-Domain Question Answering(2020)]]
  - [ ] Discuss [[./papers/2102.01335.pdf][Neural Data Augmentation via Example Extrapolation(2020)]]

* TODO Action #02 Review Augmentation by Generation [0%]
  - [ ] Discuss Neural Data Augmentation via Example Extrapolation 
  - [ ] Augmentation by paraphrase generation

* TODO Action #03 Automation[0%]
  - [ ] Get some ideas from image data augmentation
  - [ ] Autoaugment: Try different kinds of data augmentation and select policy

* IN PROGRESS Action #04 Build toy Classification Pipeline [50%]
...
* IN PROGRESS Action #05 Build toy augmentation using retrieval [0%]
...
* IN PROGRESS Action #99 Collect Relevant Papers [0%]
  - [ ] Embedding
