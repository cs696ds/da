...
* TODO Action #02 Discuss additional ideas [0%]
  - [ ] Augmentation by paraphrase generation
  - [ ] Get some ideas from image data augmentation automation
  - [ ] Autoaugment: Try different kinds of data augmentation and select policy

* IN PROGRESS Action #03 Build toy Classification Pipeline [50%]
