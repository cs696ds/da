...
* TODO Action #4 Retrieval Strategy [40%]
  ...
  - [X] Base: Sudarshan's Previous work on KNN Cosine Similarity Retrieval
    #+BEGIN_SRC python
...
* TODO Action #6 Augmentation Methods[0%]
  - [ ] Augmentation by paraphrase generation

* TODO Action #7 Automation[0%]
  - [ ] Autoaugment: Try different kinds of data augmentation and select policy

* IN PROGRESS Action #8 Collect Relevant Papers [33%]
  - [X] Embedding
    ...
    - [[./papers/beta_vae.pdf][Disentangled Variational Autoencoder]]

  - [X] Augmentation by Retrieval
